...
class JsonConvert {
	static final Map<String, JsonConvertFunction> _convertFuncMap = {
		...
		(ProductListRating).toString(): ProductListRating.fromJson,
	};
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<ProductListRating>[] is M){
			return data.map<ProductListRating>((Map<String, dynamic> e) => ProductListRating.fromJson(e)).toList() as M;
		}
